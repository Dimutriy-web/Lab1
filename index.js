...
function getBase64CodeByUtf8Unit8Arr(unit8Arr) {
  ...
  // ostachaVidTreh це змінна, яка вкузує на остачу від третьої ітерації, вона потрібна, щою розуміти коли було пройдено 3 елементи масива (3 байти), бо щоб отримати base-64 код, треба взяти 3 байти (24 біт), та розбити їх по 6 (вийде 4 елементи)
  let ostachaVidTreh;

  // base64Text - вихідний результат
  let base64Text = '';

  // _24bitToFill - змінна 24 біт
  let _24bitToFill = 0;
  for (let i = 0; i < unit8Arr.length; i++) {
    ...
    // або 24 біти заповнені, або кінцева ітеранія 11000 & 01000 = 01000
